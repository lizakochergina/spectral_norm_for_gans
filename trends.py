...
def make_trend_plot(feature_real, real, feature_gen, gen, name, calc_chi2=False, figsize=(8, 8), pngfile=None):
    ...
    if pngfile is not None: fig.savefig(pngfile, format='png')
    plt.close(fig)
    buf.seek(0)
